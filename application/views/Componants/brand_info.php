        ...
        success: function(data){
          ...
          for(var key in data){
            tbody +="<tr>";
              ...
              tbody += "<td><button class='btn btn-sm btn-danger' id='del_id' del_id="+data[key]['id']+"><i class='fas fa-trash-alt'></i></button> || <button class='btn btn-sm btn-primary' id='edit_id' edit_id = "+data[key]['id']+"><i class='fas fa-edit'></i></button></td>";
